...
export default {
  title: 'Message-Toggle/MessageToggleLatestMessage',
  decorators: [
    withKnobs,
    moduleMetadata({
...
export const MessageToggleLatestMessage = () => ({
  template: `<rbn-button-show-message>  </rbn-button-show-message>
  <rbn-message-toggle [showLatestMessage]="true"></rbn-message-toggle>`
});
